...
document.querySelector('#activeFilter button').addEventListener('click',()=>{{chartFilter=null;render();}});options();communityOptions();render();renderCommunity();
</script></body></html>'''
